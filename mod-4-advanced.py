...
# Define the social_graph dictionary
social_graph = {
...
print(tic_tac_toe_winner(board4))
print(tic_tac_toe_winner(board5))
print(tic_tac_toe_winner(board6))
print(tic_tac_toe_winner(board7))
...
def eta(first_stop, second_stop, route_map):
    ...
    while current_stop != second_stop:
        if (current_stop, second_stop) in route_map:
            total_travel_time += route_map[(current_stop, second_stop)]['travel_time_mins']
            break
        else:
            next_stop = None
